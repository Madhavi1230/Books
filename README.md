...
<link rel=File-List
href="file:///C:/Users/SATYAK~1/AppData/Local/Temp/msohtmlclip1/01/clip_filelist.xml">
<!--[if gte mso 9]><xml>
...
<link rel=themeData
href="file:///C:/Users/SATYAK~1/AppData/Local/Temp/msohtmlclip1/01/clip_themedata.thmx">
<link rel=colorSchemeMapping
href="file:///C:/Users/SATYAK~1/AppData/Local/Temp/msohtmlclip1/01/clip_colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
...
Description | Evaluation | Likelihood | Impact   Level | Responsibility | Response | Measures
-- | -- | -- | -- | -- | -- | --
Computer used   by kids and messed with my data | Computer dies   and not able to recover data | Low | High | Me | Have a back   up laptop or use another’s laptop/desktop and escalate the same to trainer | Keep it from   reach of kids /pets and have back up code in GitHub
Power cut | There is no   power supply | Low | High | Govt | Try to use batteries   or ethernet supply. Hotspot from mobile could also work | Have a backup   of code and frequent updates to GitHub help.
Illness | Developer is   ill and may not submit the project as per SLA | Medium | High | Me | Check with   trainer if date extension possible for submission | Proper medication   and advice from health care professional for speedy recovery.
...
![image](https://user-images.githubusercontent.com/109301588/190615038-bf857778-2190-4976-b0ca-a5842695b402.png)
